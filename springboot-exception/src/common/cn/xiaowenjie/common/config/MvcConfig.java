...
import cn.xiaowenjie.common.authorization.interceptor.CurrentUserMethodArgumentResolver;

/**
 * 配置类，增加自定义拦截器和解析器
 * @see cn.xiaowenjie.common.authorization.interceptor.scienjus.authorization.resolvers.CurrentUserMethodArgumentResolver
